...
function App() {
  ...
  // Inputs and outputs
  const [input, setInput] = useState('What is the height of the Eiffel Tower?');
  const [context, setContext] = useState(`The Eiffel Tower is a wrought iron lattice tower in Paris, France. It was designed by Gustave Eiffel and completed in 1889.
